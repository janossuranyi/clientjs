...
(function(scope) {
  ...
  ClientJS.prototype = {
    ...
    // Get Fonts.  Return a string containing a list of installed fonts. Returns false when timeout occured
    getFontsWithTimeout: function(maxTimeMs) {
      var fontString = "";
      ...
      for (var i = 0; i < fontArray.length; i++) {
        ...
        elapsed = (new Date()).getTime() - start_ts;
        if (elapsed >= maxTimeMs) {
        	console.log("getFonts timeout: " + elapsed);
        	return false;
        }
      }
      return fontString;
